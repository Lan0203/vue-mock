<template>
  <div class="avue-tags">
    ...
    <div :class="{'avue-tags__box--close':!isFirstPage}" class="avue-tags__box">
      <el-tabs v-model="active" :closable="tagLen!==1" type="card" 
        @contextmenu.native="handleContextmenu" @tab-click="openTag" @edit="menuTag"
      >
