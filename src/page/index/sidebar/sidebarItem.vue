<template>
  <div class="menu-wrapper">
    <template v-for="item in menu">
      <el-menu-item v-if="validatenull(item[childrenKey]) && vaildRoles(item)" :title="item[labelKey]" 
      ...
      >
        ...
        <template v-for="(child,cindex) in item[childrenKey]">
          <el-menu-item  v-if="validatenull(child[childrenKey])" :title="child[labelKey]"
            :index="child[pathKey],cindex" :class="{'is-active':vaildAvtive(child)}" 
            :key="child[labelKey]"  @click="open(child)"
          >
